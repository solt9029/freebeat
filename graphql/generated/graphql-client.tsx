...
export type CreatePlaylistMutation = { __typename?: 'Mutation' } & {
  createPlaylist?: Maybe<
    { __typename?: 'CreatePlaylistPayload' } & {
      playlist: { __typename?: 'Detail' } & Pick<Detail, 'id' | 'key'>
    }
  >
}
...
export type UpdatePlaylistMutation = { __typename?: 'Mutation' } & {
  updatePlaylist?: Maybe<
    { __typename?: 'UpdatePlaylistPayload' } & {
      playlist: { __typename?: 'Base' } & Pick<Base, 'id'>
    }
  >
}
...
export type CreateVideoMutation = { __typename?: 'Mutation' } & {
  createVideo?: Maybe<
    { __typename?: 'CreateVideoPayload' } & {
      video: { __typename?: 'Video' } & Pick<Video, 'id'>
    }
  >
}
...
export type CreateVideosMutation = { __typename?: 'Mutation' } & {
  createVideos?: Maybe<
    { __typename?: 'CreateVideosPayload' } & {
      videos: Array<{ __typename?: 'Video' } & Pick<Video, 'id'>>
    }
  >
}
...
export type PlaylistQuery = { __typename?: 'Query' } & {
  playlist: { __typename?: 'Base' } & Pick<
    Base,
    'id' | 'title' | 'defaultBpm'
  > & {
              ...
              { __typename?: 'VideoEdge' } & {
                node?: Maybe<
                  { __typename?: 'Video' } & Pick<
                    Video,
                    'id' | 'youtubeVideoId' | 'youtubeVideoTitle' | 'bpm'
                  >
                >
              }
            >
...
`
export type CreateVideosMutationFn = Apollo.MutationFunction<
  CreateVideosMutation,
  CreateVideosMutationVariables
>
 ...
 * });
 */
export function useCreateVideosMutation(
  baseOptions?: Apollo.MutationHookOptions<
    CreateVideosMutation,
    CreateVideosMutationVariables
  >,
  ...
  return Apollo.useMutation<
    CreateVideosMutation,
    CreateVideosMutationVariables
  >(CreateVideosDocument, options)
}
export type CreateVideosMutationHookResult = ReturnType<
  typeof useCreateVideosMutation
>
export type CreateVideosMutationResult =
  Apollo.MutationResult<CreateVideosMutation>
export type CreateVideosMutationOptions = Apollo.BaseMutationOptions<
  CreateVideosMutation,
  CreateVideosMutationVariables
>
